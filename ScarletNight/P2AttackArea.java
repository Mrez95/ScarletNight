import greenfoot.*;
public class P2AttackArea extends SystemCore
{
/**
 ...
 */
    ...
    double damage = 0.1;
public P2AttackArea(int xCoordinate, int yCoordinate, int getWidth, int getLength, int timeLast, int getDelay,double getDamage,int getForce,boolean getForceDirection)
    {
        this.time = timeLast;
        this.x = xCoordinate;
        this.y = yCoordinate;
